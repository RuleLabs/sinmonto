...
2. Lis [`docs/constitution-finale.md`](../constitution-finale.md) §2 — les
...
place dans [`docs/roadmap-vision.md`](../roadmap-vision.md), pas dans le
noyau tout de suite.
...
processus du **contrat vivant** ([`docs/contrat-vivant-gabarit.md`](../contrat-vivant-gabarit.md)) :
...
[`docs/journal-integration.md`](../journal-integration.md) documente
